...
public class Ch16Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
            ...
            if(result== PackageManager.PERMISSION_GRANTED){
                ...
                requestPermissions(new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE},103);
            }
        }
                    ...
                    cameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try{
                                ...
                                cameraCaptureSession.setRepeatingRequest(previewRequest,null,null);//在会话中发出重复请求，进行预览
                            }catch (Exception e){
                                Log.e(Ch16Activity1.class.toString(),e.toString());
                            }
                        }
    ...
    private void sendSms(){
        //借助于SmsManager工具进行发送
        SmsManager smsManager=SmsManager.getDefault();//获得实例
        smsManager.sendTextMessage("13309978123","132455112333","short message test",null,null);
    }
    ...
    private void openCamera(int width,int height){
        ...
        try{
            cameraManager.openCamera("0",stateCallback,null);//"0"代表后置摄像头 "1"代表前置
        }catch (Exception e){
            Log.e(Ch16Activity1.class.toString(),e.toString());
        }
    }
    ...
    private  void callPhone(){
        Intent intent=new Intent(Intent.ACTION_CALL, Uri.parse("tel://13423345612"));
